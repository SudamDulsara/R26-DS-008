...
def stage1_grapheme_refinement(raw_ocr_text: str) -> dict:
    ...
    # that the downstream LLM cannot detect. The LLM stage handles merging
    # better because it sees the full sentence context.
    word_boundary_used = False
    print("[Stage 1] Rule 6 skipped — word boundary merging delegated to the LLM stage")
